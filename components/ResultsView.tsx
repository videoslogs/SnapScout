...
export const ResultsView: React.FC<ResultsViewProps> = ({ data, imagePreview, onReset, onSave, isSaved }) => {
  ...
  return (
    <div className="pb-32 animate-pop-in">
           ...
           {!mainImageError && displayImage ? (
             ...
             <div className="flex flex-col items-center justify-center text-center animate-pop-in z-10">
                ...
                <div className="space-y-0.5">
                   ...
                   <p className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 animate-shimmer bg-[length:200%_auto] tracking-tight drop-shadow-sm">{cheapestRetailer.price}</p>
      ...
      <CollapsibleWidget title="Detailed Analysis" icon={FileText} iconColor="text-game-primary" defaultOpen={true} className="mb-6">
